...
- **自動化備份 (Docker)**：容器內建 `scheduler.py`，每天 **09, 10, 11, 12, 14** 時自動執行備份。
...
- **2026-04-06**: **v1.4.7** - 🚀 **強化健康數據獲取、優化排程頻率與移除廢棄功能。**
    - 優化熱血時間數據獲取邏輯，支援週端點查詢並新增 `--progress` 進度條顯示。
    - 移除已廢棄的 `insights` 子命令，簡化健康數據中心功能。
    - 擴展 `scheduler.py` 備份排程執行時間，提高數據備份即時性。
    - 更新賽事預測 API 端點，提升數據解析的穩定性與兼容性。
...
---
*Generated by Gemini CLI - 2026-04-06*
